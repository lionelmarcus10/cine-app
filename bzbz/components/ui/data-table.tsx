      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="start">
          <DropdownMenuItem onClick={() => column.toggleSorting(false)}>
            <ArrowUpIcon className="mr-2 h-3.5 w-3.5 text-gray-500/70 dark:text-gray-400/70" />
            Asc
          </DropdownMenuItem>
          <DropdownMenuItem onClick={() => column.toggleSorting(true)}>
            <ArrowDownIcon className="mr-2 h-3.5 w-3.5 text-gray-500/70 dark:text-gray-400/70" />
            Desc
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
...
export const TableRow = ({ row, children, className }: TableRowProps) => (
  <TableRowRaw
    ...
    className={className}
    onClick={() => {
      // Replace alert with a function to display the row ID
